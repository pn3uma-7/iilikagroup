          ...
          <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-24">
            <div className="max-w-3xl space-y-6">
              ...
              <p className="text-sm md:text-base uppercase tracking-[0.2em] text-white/80 font-medium">
                Hire Talent &middot; Join Us &middot; Partner
              </p>
      ...
      <section className="bg-[#1a1a1a] py-16">
        <div className="container-custom">
          <div className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 uppercase">Get In Touch</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-white/10 rounded-lg p-6">
              <svg
                className="w-8 h-8 text-[#FF000E] mb-4"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
              ...
              <h3 className="font-semibold text-white mb-3 uppercase tracking-wide">Locations</h3>
              <p className="text-white/60 text-sm">Pune, Maharashtra</p>
              <p className="text-white/60 text-sm">Nashik, Maharashtra</p>
            </div>
            <div className="border border-white/10 rounded-lg p-6">
              <svg
                className="w-8 h-8 text-[#FF000E] mb-4"
              ...
              <h3 className="font-semibold text-white mb-3 uppercase tracking-wide">Email</h3>
            ...
            <div className="border border-white/10 rounded-lg p-6">
              ...
              <h3 className="font-semibold text-white mb-3 uppercase tracking-wide">Phone</h3>
              <p className="text-white/60 text-sm">Available on request</p>
            </div>
          </div>
        </div>
      </section>
